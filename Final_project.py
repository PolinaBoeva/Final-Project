...
st.markdown('''Заработные платы с учетом инфляции (реальные заработные платы) рассчитаны в ценах базового 2000 года.  
**ИПЦ баз** - базисный индекс потребительских цен.  
**ИНЗ** - индекс номинальной заработной платы.  
...
st.header("Рассмотрим корреляцию социальноэкономических показателей с динамикой реальных зарплат")
fig, ax = plt.subplots(figsize=(8, 4))
